...
public class PaymentController {
    ...
    @ApiResponses({
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Payment initiated — redirect URL or reference returned"),
    ...
    public ResponseEntity<ApiResponse<Payment>> initiate(@Valid @RequestBody InitiatePaymentRequest request) {
